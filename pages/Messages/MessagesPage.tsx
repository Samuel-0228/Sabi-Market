...
const MessagesPage: React.FC<MessagesProps> = ({ user }) => {
  ...
  if (loading) return (
    <div className="h-[80vh] flex flex-col items-center justify-center opacity-40">
      ...
      <p className="text-[10px] font-black uppercase tracking-widest dark:text-white">Opening Inbox...</p>
    </div>
  );
    ...
    <div className="max-w-[1400px] mx-auto px-6 py-10 h-[85vh] flex flex-col lg:flex-row gap-8 animate-in fade-in duration-700">
      <div className="w-full lg:w-96 bg-white dark:bg-[#0c0c0e] rounded-[2.5rem] border border-gray-100 dark:border-white/5 flex flex-col overflow-hidden shadow-2xl">
        <div className="p-8 border-b dark:border-white/5 bg-gray-50/20 dark:bg-black/20">
          ...
          <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mt-1">AAU Campus Trading</p>
        </div>
      ...
      <div className="flex-1 bg-white dark:bg-[#0c0c0e] rounded-[2.5rem] flex flex-col border border-gray-100 dark:border-white/5 overflow-hidden shadow-2xl relative">
        {activeConv ? (
          <>
            <div className="p-8 border-b dark:border-white/5 flex justify-between items-center bg-gray-50/30 dark:bg-black/20">
              ...
              <div className="text-right">
                ...
                <span className="text-[8px] font-black text-green-500 uppercase tracking-widest">AAU Verified</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSend} className="p-8 border-t dark:border-white/5 flex gap-5 bg-white dark:bg-[#0c0c0e]">
               ...
               />
               <button className="bg-black dark:bg-white text-white dark:text-black px-10 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-2xl active:scale-95 transition-all">Send Message</button>
            </form>
          </>
        ) : (
          <div className="flex-1 flex flex-col items-center justify-center text-center p-20">
            ...
            <p className="text-gray-400 font-medium max-w-xs mt-4">Select a chat from the left to manage your inquiries.</p>
          </div>
        )}
      </div>
